...
var rfcTestVector1_sym = [57]byte{
...
var rfcTestVector1_expectedPub = [57]byte{
...
var rfcTestVector1_msg = []byte{}

var rfcTestVector1_sig = [114]byte{
...
var rfcTestVector2_sym = [57]byte{
...
var rfcTestVector2_expectedPub = [57]byte{
...
var rfcTestVector2_msg = []byte{
	0x03,
}

var rfcTestVector2_sig = [114]byte{
...
var rfcTestVector4_sym = [57]byte{
...
var rfcTestVector4_expectedPub = [57]byte{
...
var rfcTestVector4_msg = []byte{
	0x0c, 0x3e, 0x54, 0x40, 0x74, 0xec, 0x63, 0xb0,
	0x26, 0x5e, 0x0c,
}

var rfcTestVector4_sig = [114]byte{
...
var rfcTestVector5_sym = [57]byte{
...
var rfcTestVector5_expectedPub = [57]byte{
...
var rfcTestVector5_msg = []byte{
	0x64, 0xa6, 0x5f, 0x3c, 0xde, 0xdc, 0xdd, 0x66,
	0x81, 0x1e, 0x29, 0x15,
}

var rfcTestVector5_sig = [114]byte{
...
var rfcTestVector6_sym = [57]byte{
...
var rfcTestVector6_expectedPub = [57]byte{
...
var rfcTestVector6_msg = []byte{
	0x64, 0xa6, 0x5f, 0x3c, 0xde, 0xdc, 0xdd, 0x66,
	0x81, 0x1e, 0x29, 0x15, 0xe7,
}

var rfcTestVector6_sig = [114]byte{
...
var rfcTestVector7_sym = [57]byte{
...
var rfcTestVector7_expectedPub = [57]byte{
...
var rfcTestVector7_sig = [114]byte{
...
var rfcTestVector8_sym = [57]byte{
...
var rfcTestVector8_expectedPub = [57]byte{
...
var rfcTestVector8_sig = [114]byte{
...
var rfcTestVector9_sym = [57]byte{
...
var rfcTestVector9_expectedPub = [57]byte{
...
var rfcTestVector9_sig = [114]byte{
