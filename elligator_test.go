...
func (s *Ed448Suite) Test_PointFromUniformHash(c *C) {
	...
	exp := &twExtendedPoint{
		&bigNumber{
			0x733a0e6, 0x565dc88, 0x5b952cf, 0xac980c7,
			0x6f8790a, 0x68b9aa4, 0x3ffb7ac, 0xf9498f8,
			0xc9f684f, 0x5a4009e, 0xd3b77fa, 0x5d415d3,
			0xc1b1986, 0x8e8f930, 0xe71fded, 0xc4e739,
		},
		&bigNumber{
