...
func (s *Ed448Suite) TestBarrettDeserializeAndReduce(c *C) {
	...
	result := [scalarWords]uint32{}

	barrettDeserializeAndReduce(result[:], serialized[:], &curvePrimeOrder)

	c.Assert(result, DeepEquals, [scalarWords]uint32{
...
func (s *Ed448Suite) Test_ComparisonBetweenBarrettDeserializeAndDecafDecodeLong(c *C) {
	serialized := [64]byte{
		0xd0, 0x7e, 0xbf, 0x66, 0x0e, 0xbb, 0x5f, 0xd1,
		0x6b, 0xeb, 0xd4, 0x08, 0xe6, 0x15, 0x1e, 0xf7,
		0x57, 0x7b, 0x8e, 0xdd, 0x11, 0xa6, 0x50, 0x99,
		0x9e, 0x7d, 0xd5, 0x2d, 0x0e, 0x70, 0x9a, 0x77,
		0x21, 0xa7, 0xda, 0xa3, 0x15, 0xb6, 0xd8, 0xd5,
		0xa4, 0xe7, 0x1c, 0x1f, 0x50, 0xc7, 0xc9, 0x52,
		0xe7, 0x58, 0x4c, 0x74, 0xda, 0x03, 0x3b, 0xfc,
		0xd8, 0x81, 0x29, 0x4d, 0x4b, 0xc7, 0xe3, 0x81,
	}
	...
	c.Assert(result, DeepEquals, [scalarWords]uint32{
		0xa8282fd7, 0x8f60cab1,
		0x9e87266a, 0xbd3a3898,
		0xaf6bcd88, 0xaf6bddb8,
		0x4ee80f23, 0xc06c2785,
		0xae26325c, 0xd5d8b616,
		0x1f1ce7a4, 0x52c9c750,
		0x744c58e7, 0x3c3b03da,
	})

	serialized2 := [64]byte{
		0x72, 0x01, 0xfb, 0xf6, 0x2b, 0xf6, 0x1e, 0x74,
		0xdc, 0x65, 0x39, 0xcd, 0xbd, 0x23, 0x19, 0x2b,
		0x01, 0x0b, 0xe0, 0x6d, 0x1f, 0x3f, 0x32, 0x29,
		0xd8, 0x36, 0x8f, 0x8e, 0x30, 0xd7, 0x17, 0x2a,
		0x3f, 0xa1, 0x81, 0x11, 0x5d, 0x46, 0xdf, 0x85,
		0x9a, 0x17, 0x0b, 0x2e, 0xcf, 0x2e, 0xc4, 0x3a,
		0x7c, 0xbb, 0xb7, 0x03, 0xe0, 0x3d, 0x36, 0xb9,
		0x12, 0xe2, 0xe4, 0xb7, 0x75, 0xee, 0x69, 0xe5,
	}

	result2 := [scalarWords]uint32{}

	barrettDeserializeAndReduce(result2[:], serialized2[:], &curvePrimeOrder)

	c.Assert(result2, DeepEquals, [scalarWords]uint32{
		0x464cfb34, 0x1f3c46de,
		0x2d2f9295, 0x88c18677,
		0x7d184a3d, 0x970b914d,
		0xc5164c8d, 0x6e13e478,
		0xe7d785fd, 0x85df465e,
		0x2e0b179a, 0x3ac42ecf,
		0x03b7bb7c, 0x39363de0,
	})
}
