...
func (s *Ed448Suite) Test_DecafDecode(c *C) {
	...
	ok, err := decafDecode(p, serialized{
	...
	ok, err = decafDecode(q, serialized{
		0xe4, 0xb2, 0xa1, 0xa1, 0x43, 0x95, 0xb5,
		0xeb, 0x3a, 0x5c, 0x3f, 0x3d, 0x26, 0x57,
		0x82, 0xef, 0xc2, 0x8b, 0x9a, 0x94, 0xcc,
		0x1d, 0x46, 0xff, 0xf8, 0x72, 0x50, 0x79,
...
func (s *Ed448Suite) Test_DsaLikeSerialize(c *C) {
	n := &bigNumber{
		0x04ced9a5, 0x0a48906a,
		0x09f09413, 0x0e0fe326,
		0x007b11db, 0x0687875e,
		0x0044482c, 0x0c6e93b7,
		0x006cde64, 0x0a3a5d6e,
		0x0938e74e, 0x0930cb3d,
		0x088d7575, 0x006de50e,
	...
	exp := []byte{
		...
		0x6, 0x2c, 0xb9, 0x75, 0x50, 0x7d, 0x24, 0x85, 0x0,
	}

	dsaLikeSerialize(out, n, 1)
...
func (s *Ed448Suite) Test_DsaLikeEncode(c *C) {
	...
	exp := [57]byte{
		...
		0xd6, 0xa5, 0xa3, 0x4e, 0xe7, 0x38, 0xd9, 0xb3,
		0x0c, 0x93, 0x75, 0x75, 0x8d, 0xe8, 0x50, 0xde,
		0x6, 0x2c, 0xb9, 0x75, 0x50, 0x7d, 0x24, 0x85, 0x00,
	}
...
func (s *Ed448Suite) Test_DsaLikeDecode(c *C) {
	ser := [57]byte{
		...
		0xd6, 0xa5, 0xa3, 0x4e, 0xe7, 0x38, 0xd9, 0xb3,
		0x0c, 0x93, 0x75, 0x75, 0x8d, 0xe8, 0x50, 0xde,
		0x06, 0x2c, 0xb9, 0x75, 0x50, 0x7d, 0x24, 0x85, 0x00,
	}
