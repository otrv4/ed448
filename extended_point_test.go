...
func (s *Ed448Suite) Test_Deisogenize(c *C) {
	...
	q := &twExtendedPoint{
		...
		&bigNumber{
			0x01ff5b2b, 0x06b9b14c, 0x0bdb2bc2, 0x0256b19a,
			0x0dd7ef78, 0x05a7cb30, 0x04df2bcc, 0x0d68d3a0,
			0x0c2ed8b7, 0x0a578406, 0x06d564ae, 0x0fd10109,
			0x017e32b0, 0x02c29749, 0x0dbc3031, 0x047c349a,
		},
		&bigNumber{
			0x0e00a4d4, 0x09464eb3, 0x0424d43d, 0x0da94e65,
			0x02281087, 0x0a5834cf, 0x0b20d433, 0x02972c5f,
			0x03d12747, 0x05a87bf9, 0x092a9b51, 0x002efef6,
			0x0e81cd4f, 0x0d3d68b6, 0x0243cfce, 0x0b83cb65,
		},
		&bigNumber{
			0x0fffffff, 0x0fffffff, 0x0fffffff, 0x0fffffff,
			0x0fffffff, 0x0fffffff, 0x0fffffff, 0x0fffffff,
	...
	sc = q.deisogenizeNew(inv11, inv21, toggleS, toggleAltX)
	...
	sc = q.deisogenizeNew(inv12, inv22, word(0xff), toggleAltX)
