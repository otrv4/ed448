...
func (s *Ed448Suite) TestDecafDecode2(c *C) {
...
func (s *Ed448Suite) Test_NewPoint(c *C) {
	...
	c.Assert(err, IsNil)
	c.Assert(p, DeepEquals, &twExtendedPoint{
		&bigNumber{
			0x034365c8, 0x06b2a874,
			0x0eb875d7, 0x0ae4c7a7,
			0x0785df04, 0x09929351,
...
func (s *Ed448Suite) Test_IdentityCannotBeAPoint(c *C) {
	identity := &twExtendedPoint{&bigNumber{0}, &bigNumber{1}, &bigNumber{1}, &bigNumber{0}}
	encoded := [fieldBytes]byte{}
	identity.decafEncode(encoded[:])

	_, err := NewPoint(encoded)

	c.Assert(err, ErrorMatches, "ed448: the serialized input could not be decoded as a valid point")
}
...
func (s *Ed448Suite) Test_twPNielsToExtended(c *C) {
	pn := &twPNiels{
		&twNiels{
			...
			&bigNumber{0x01034f2a, 0x0eae9078, 0x0f3efa41, 0x039389e4, 0x04f19d1d, 0x05e8f21c, 0x081e279d, 0x01011eca, 0x06f90064, 0x068cfe2b, 0x08b95f11, 0x0144de8a, 0x04022ab1, 0x087d7dca, 0x0129b8ca, 0x0c3a54aa},
		},
	...
	expected := &twExtendedPoint{
		&bigNumber{0x0f28f6b9, 0x031242e7, 0x025075a3, 0x089c6fef, 0x0c7aad41, 0x08072e8b, 0x00d25064, 0x0fee9931, 0x039d8756, 0x08c9750e, 0x02a13cdd, 0x05f83a36, 0x0f15eaf3, 0x08641e57, 0x0283f647, 0x0e176bf0},
		&bigNumber{0x0538a2be, 0x05dccef4, 0x0e1f3db4, 0x0987f28b, 0x025654bb, 0x0015ccbc, 0x0ad1978a, 0x00e352a8, 0x0b404516, 0x093ebe46, 0x0cef87de, 0x09d51db5, 0x09936823, 0x075b8fae, 0x0b49e190, 0x029b4497},
		&bigNumber{0x026644d3, 0x03978937, 0x02d980ab, 0x0932cef7, 0x01f40638, 0x07e71e49, 0x0cb9ac94, 0x0db56f31, 0x008d6c2b, 0x01eaad17, 0x0be10c32, 0x04f7381e, 0x0fffe02c, 0x0f5d619b, 0x0020e408, 0x02d2ddba},
		&bigNumber{0x09892a57, 0x0fe01c67, 0x00431201, 0x040373e2, 0x0e08643f, 0x01adb24a, 0x0ec4e7ad, 0x0d41c3ed, 0x02d82f6d, 0x0f010b33, 0x0e0cb94a, 0x08668c81, 0x0549b386, 0x0efbdfa8, 0x0cf765f1, 0x01332bf3},
	}

	c.Assert(pn.twExtendedPoint(), DeepEquals, expected)
}
